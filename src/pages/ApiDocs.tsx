      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className={`text-center mb-12 max-w-2xl mx-auto ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            Integrate our SMM services into your own applications using our REST API
          </p>
          ...
          <div className="card-neon p-6 mb-8">
            ...
            <p className={isDarkMode ? 'text-gray-300' : 'text-gray-700'}>
              Our API allows you to programmatically access our SMM services. You can fetch available services,
